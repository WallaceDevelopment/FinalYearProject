...
router.get('/', function(req, res, next) {
  ...
  if (req.session.user) {
    ...
    res.render('register', { username: username, full_name: full_name, email : email, user : user }); //ensure that this is the file name and not a file path when rendering new pages
